...
* Screenshots
** Home Page
[[file:steps/6/screenshots/0-home.png]]
** Troopers
[[file:steps/6/screenshots/1-troopers.png]]
** Garrisons
[[file:steps/6/screenshots/2-garrisons.png]]
** Loadouts
[[file:steps/6/screenshots/3-loadouts.png]]
** Ships
[[file:steps/6/screenshots/4-ships.png]]
** Droids
[[file:steps/6/screenshots/5-droids.png]]
** Ship Manifests
[[file:steps/6/screenshots/6-ship-manifests.png]]
* Installation and Usage
** Install dependencies with npm
- after cloning the repository navigate to the app directory
  #+begin_src bash
    cd osu-cs-340-project/empire-employees/
    npm install
  #+end_src
** Credentials
