...
INSERT INTO `droids` VALUES (1,'Protocol'),(2,'Astromech'),(3,'Hunter-Killer');
...
CREATE TABLE `ships_droids` (
  ...
  KEY `droid` (`droid`),
  CONSTRAINT `ships_droids_ibfk_1` FOREIGN KEY (`ship`) REFERENCES `ships` (`id`),
  CONSTRAINT `ships_droids_ibfk_2` FOREIGN KEY (`droid`) REFERENCES `droids` (`id`)
...
CREATE TABLE `ships_troopers` (
  ...
  KEY `trooper` (`trooper`),
  CONSTRAINT `ships_troopers_ibfk_1` FOREIGN KEY (`ship`) REFERENCES `ships` (`id`),
  CONSTRAINT `ships_troopers_ibfk_2` FOREIGN KEY (`trooper`) REFERENCES `troopers` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `troopers` (
  ...
  PRIMARY KEY (`id`),
  KEY `garrison` (`garrison`),
  KEY `loadout` (`loadout`),
  CONSTRAINT `troopers_ibfk_1` FOREIGN KEY (`garrison`) REFERENCES `garrisons` (`id`),
  CONSTRAINT `troopers_ibfk_2` FOREIGN KEY (`loadout`) REFERENCES `loadouts` (`id`)
...
-- Dump completed on 2020-07-24 20:41:12
